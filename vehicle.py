...
min_width_rect=80   #min_width_rect
min_height_rect=80
...
while True:
    ...
    dilat = cv2.dilate(img_sub,np.ones((5,5)))      #Dilat an image by specific structure or element....Structure la detect karto and pixels la ektra jodh do dilat
    ...
    cv2.putText(frame1,"Vehicle Counter :"+str(counter),(450,70),cv2.FONT_HERSHEY_SCRIPT_SIMPLEX,2,(0,0,255),5)
